...
public class DieMessageDirectReceiver {
	 ...
	 * @param json 消息
	 */
	@RabbitListener(bindings = @QueueBinding(value = @Queue(name = DIRECT_ORDER_PAY_QUEUE, durable = "true"), exchange = @Exchange(value = DIRECT_ORDER_PAY_EXCHANGE), key = DIRECT_ORDER_PAY_QUEUE))
	@RabbitHandler
	 ...
	 * @param json 消息
	 */
	@RabbitListener(bindings = @QueueBinding(value = @Queue(name = DIRECT_ORDER_PAY_TTL_DIE_QUEUE, durable = "true"), exchange = @Exchange(value = DIRECT_ORDER_PAY_TTL_DIE_EXCHANGE), key = DIRECT_ORDER_PAY_TTL_DIE_QUEUE))
	@RabbitHandler
	 ...
	 * @param json 消息
	 ...
	 @RabbitHandler public void listenerDirectChangeOrderStatus(Message json){
	 ...
	 * @param json 消息
	 */
	@RabbitListener(bindings = @QueueBinding(value = @Queue(name = DIRECT_CHANGE_ORDER_STATUS_FAIL_QUEUE, durable = "true"), exchange = @Exchange(value = DIRECT_CHANGE_ORDER_STATUS_FAIL_EXCHANGE), key = DIRECT_CHANGE_ORDER_STATUS_FAIL_QUEUE))
	@RabbitHandler
